                                        ...
                                        >
                                            ...
                                            {data?.status && data?.status === 'Pending' && (
                                                <div className="w-full flex flex-row justify-start items-center gap-2" >
                                                    ...
                                                    <DoneIcon sx={{ color: '#4CE13F', fontSize: 28, fontWeight: 'bold', cursor: 'pointer' }} />
                                                    <div className="font-medium text-lg text-gray-800" > | </div>
                                                    <CloseIcon sx={{ color: '#C70000', fontSize: 28, fontWeight: 'bold', cursor: 'pointer' }}  />
                                                </div>
                                            )}
                                        </td>
                                        <td
