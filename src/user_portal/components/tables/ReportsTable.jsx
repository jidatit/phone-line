                ...
                <div className="w-full px-2">
                            ...
                            <tbody>
                                {rowsToShow && rowsToShow?.map((data, index) => (
                                    ...
                                    >
                                        ...
                                        >
                                            {!data?.status ? <div> - </div> : <div>{data.status}</div>}
                                        </td>
                                        <td
                                            className={`py-2 px-3 text-base  font-normal ${index == 0
                                                ? "border-t-2 border-gray-300"
                                        ...
                                        >
                                            <button className="bg-[#FF6978] rounded-3xl text-white py-1 px-4">
                    ...
                    <div className="w-full flex justify-center sm:justify-between xl:flex-row flex-col gap-10 mt-12 lg:mt-8 px-0 lg:px-4 xl:px-4 items-center">
                        <div className="text-base text-center">
                            Showing
                            <span className="font-bold bg-[#340068] text-white mx-2 p-2 text-center rounded-lg">
                                {currentPage === 0 ? 1 : currentPage * rowPerPage + 1}
                            </span>
                            to{" "}
                            <span className="font-bold bg-[#340068] text-white mx-2 py-2 px-3 text-center rounded-lg">
